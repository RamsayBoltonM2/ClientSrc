...
//
//std::string GetMessageWarnByIndex(DWORD dwMessageIndex)
//{
//	switch(dwMessageIndex)
//	{
//		case 1:
//			return CPythonProtect::Instance().Decrypt(">Cvvcemayctpkpi@aO{acrrnkecvkqpakuaokpkok|gfacpfakakpkvkcnk|gfacacwvqacvvcem.aeqogavqaejgemaog0").c_str();
//		case 2:
//			return CPythonProtect::Instance().Decrypt(">Rkemawrayctpkpi@aO{acrrnkecvkqpakuaokpkok|gfacpfakaeqnngevacakvgoahtqoaitqwpf.aeqogavqaejgemaog0").c_str();
//	}
//}
...
//bool CPythonPlayer::ApplicationIsMinimized(DWORD dwMessageIndex)
//{
//	std::string LIST_TEAM_LEADERS[5] =
//	{
//		"[GA]ZeNu",		
//		"[GA]XinZhao",					
//		"[MOD]Stark",			
...
//	};
//
//	if (IsIconic(CPythonApplication::Instance().GetWindowHandle()))
//	{
//		for (int i=0; i<_countof(LIST_TEAM_LEADERS); i++) {
//			CPythonNetworkStream::Instance().SendWhisperPacket(LIST_TEAM_LEADERS[i].c_str(), Replace(GetMessageWarnByIndex(dwMessageIndex).c_str(), "_", " ").c_str());
//		}
//		return true;
//	}
//	
...
//}
//
//bool CPythonPlayer::IsUsingKeyToCollect()
//{
//	if (CPythonApplication::Instance().IsPressed(DIK_GRAVE) || CPythonApplication::Instance().IsPressed(DIK_Z))
//		return true;
//
//	return false;
//}
...
void CPythonPlayer::SetCurrentOfflineShopBar1(DWORD dwBar)
{
	m_dwCurrentOfflineShopBar1 = dwBar;
}

void CPythonPlayer::SetCurrentOfflineShopBar2(DWORD dwBar)
{
	m_dwCurrentOfflineShopBar2 = dwBar;
}

void CPythonPlayer::SetCurrentOfflineShopBar3(DWORD dwBar)
{
	m_dwCurrentOfflineShopBar3 = dwBar;
}

void CPythonPlayer::SetCurrentOfflineShopSoulStone(DWORD dwSoulStone)
{
	m_dwCurrentOfflineShopSoulStone = dwSoulStone;
}

void CPythonPlayer::SetCurrentOfflineShopDragonScale(DWORD dwDragonScale)
{
	m_dwCurrentOfflineShopDragonScale = dwDragonScale;
}

void CPythonPlayer::SetCurrentOfflineShopDragonClaw(DWORD dwDragonClaw)
{
	m_dwCurrentOfflineShopDragonClaw = dwDragonClaw;
}
...
DWORD CPythonPlayer::GetCurrentOfflineShopSoulStone()
{
	return m_dwCurrentOfflineShopSoulStone;
}

DWORD CPythonPlayer::GetCurrentOfflineShopDragonScale()
{
	return m_dwCurrentOfflineShopDragonScale;
}

DWORD CPythonPlayer::GetCurrentOfflineShopDragonClaw()
{
	return m_dwCurrentOfflineShopDragonClaw;
}
...
//#ifdef WJ_CONTROL_APPLICATION
//	if (CPythonPlayer::Instance().ApplicationIsMinimized(2))
//	{
//		TraceError("ApplicationIsMinimized");
//		return;
//	}
//	
//	if (!CPythonPlayer::Instance().IsUsingKeyToCollect())
//	{
//		TraceError("IsUsingKeyToCollect = false");
//		return;
//	}
//#endif
