...
void CPythonExchange::SetChequeToTarget(BYTE cheque)
{
	m_victim.cheque = cheque;
}

void CPythonExchange::SetChequeToSelf(BYTE cheque)
{
	m_self.cheque = cheque;
}

BYTE CPythonExchange::GetChequeFromTarget()
{
	return m_victim.cheque;
}

BYTE CPythonExchange::GetChequeFromSelf()
{
