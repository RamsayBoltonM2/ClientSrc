...
void initchr()
{
	...
	PyModule_AddIntConstant(poModule, "KITMiR_AFK_1",						CRaceMotionData::NAME_AFKMOD_1);
	PyModule_AddIntConstant(poModule, "KITMiR_AFK_2",						CRaceMotionData::NAME_AFKMOD_2);
