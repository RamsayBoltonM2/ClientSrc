...
PyObject * systemGetConfig(PyObject * poSelf, PyObject * poArgs)
{
	...
	return Py_BuildValue("iiiiiiiii", iRes, iFrequency, tmp->is_software_cursor, tmp->is_object_culling, tmp->music_volume, tmp->voice_volume, tmp->gamma, tmp->iDistance, tmp->shopnames_range);
#else
...
PyObject * systemSetShowRuzgar(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowRuzgar(iFlag);

	return Py_BuildNone();
}

PyObject * systemIsShowRuzgar(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowRuzgar());
}

PyObject * systemSetShowKritik(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowKritik(iFlag);

	return Py_BuildNone();
}

PyObject * systemIsShowKritik(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowKritik());
}

PyObject * systemSetShowTest(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowTest(iFlag);

	return Py_BuildNone();
}

PyObject * systemIsShowTest(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowTest());
}

PyObject * systemSetShowDuello(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowDuello(iFlag);

	return Py_BuildNone();
}

PyObject * systemIsShowDuello(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowDuello());
}
PyObject * systemSetShowMor(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowMor(iFlag);

	return Py_BuildNone();
}

PyObject * systemIsShowMor(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowMor());
}

PyObject * systemSetShowClock(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();
	
	CPythonSystem::Instance().SetShowClock(iFlag);
	
	return Py_BuildNone();
}

PyObject * systemIsShowClock(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowClock());
}
...
void initsystem()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "SetShowRuzgar", systemSetShowRuzgar, METH_VARARGS },
		{ "IsShowRuzgar", systemIsShowRuzgar, METH_VARARGS },

		{ "SetShowKritik", systemSetShowKritik, METH_VARARGS },
		{ "IsShowKritik", systemIsShowKritik, METH_VARARGS },

		{ "SetShowTest", systemSetShowTest, METH_VARARGS },
		{ "IsShowTest", systemIsShowTest, METH_VARARGS },

		{ "SetShowDuello", systemSetShowDuello, METH_VARARGS },
		{ "IsShowDuello", systemIsShowDuello, METH_VARARGS },

		{ "SetShowMor", systemSetShowMor, METH_VARARGS },
		{ "IsShowMor", systemIsShowMor, METH_VARARGS },
		
		{ "SetShowClock",	systemSetShowClock,	METH_VARARGS },
		{ "IsShowClock",	systemIsShowClock,	METH_VARARGS },
