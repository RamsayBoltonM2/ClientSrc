...
enum
{
	...
	HEADER_CG_ENABLE_PARTY_MATCHING_SYSTEM						= 32,
	#endif
	//HEADER_BLANK33								= 33,
	//HEADER_BLANK34								= 34,
	//HEADER_BLANK35								= 35,
...
#ifdef ENABLE_SLOTING_EX_SYSTEM
typedef struct packet_newquickslot_add
{
    BYTE        header;
    BYTE        pos;
	TNewQuickSlot	slot;
} TPacketGCNewQuickSlotAdd;

typedef struct packet_newquickslot_del
{
    BYTE        header;
    BYTE        pos;
} TPacketGCNewQuickSlotDel;

typedef struct packet_newquickslot_swap
{
    BYTE        header;
    BYTE        pos;
    BYTE        change_pos;
} TPacketGCNewQuickSlotSwap;
#endif
