...
#endif
			EFFECT_ACCE_SPECIAL,	//+22
			EFFECT_BODYARMOR_NEW_DEAMON,
			EFFECT_COSTUMEBODY_SPECIAL,
			EFFECT_COSTUMEBODY_SPECIAL2,
			EFFECT_COSTUMEBODY_SPECIAL3,
			EFFECT_COSTUMEBODY_SPECIAL4,
			EFFECT_COSTUMEBODY_SPECIAL5,
			EFFECT_BODYARMOR_ELECTRIC,
