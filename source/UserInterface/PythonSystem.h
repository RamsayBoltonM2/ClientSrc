...
class CPythonSystem : public CSingleton<CPythonSystem>
{
	...
	public:
		...
		void							SetShowRuzgar(int iFlag);
		bool							IsShowRuzgar();
		
		bool							IsSnowTexturesMode();
		void							SetSnowTexturesMode(int iFlag);	

		void							SetShowKritik(int iFlag);
		bool							IsShowKritik();
		void							SetShowTest(int iFlag);
		bool							IsShowTest();
		void							SetShowDuello(int iFlag);
		bool							IsShowDuello();
		void							SetShowMor(int iFlag);
		bool							IsShowMor();

		void							SetShowClock(int iFlag);
		bool							IsShowClock();
