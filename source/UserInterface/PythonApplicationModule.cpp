...
#define APP_TITLE "gamesecurity.eu"
...
#ifdef ENABLE_WHISPER_FLASHING_SYSTEM
...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_INGAME_SUPPORT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_INGAME_SUPPORT_SYSTEM", 0);
#endif

#ifdef ENABLE_OXEVENT_EX_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_OXEVENT_EX_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_OXEVENT_EX_SYSTEM", 0);
#endif

#ifdef ENABLE_SLOTING_EX_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SLOTING_EX_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SLOTING_EX_SYSTEM",	0);
#endif

#ifdef ENABLE_PVP_TOURNAMENT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_PVP_TOURNAMENT_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PVP_TOURNAMENT_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TRANSMUTATION_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TRANSMUTATION_SYSTEM", 0);
#endif

#ifdef ENABLE_BLEND_AFFECTIVE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_BLEND_AFFECTIVE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BLEND_AFFECTIVE_SYSTEM", 0);
#endif

#ifdef ENABLE_GF_UPDATE_STROKE_INFORMATION
	PyModule_AddIntConstant(poModule, "ENABLE_GF_UPDATE_STROKE_INFORMATION",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GF_UPDATE_STROKE_INFORMATION",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_INGAME_MASTER_BAN_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_INGAME_MASTER_BAN_SYSTEM",	0);
#endif

#ifdef ENABLE_REFINE_WINDOW_EXTEND_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_WINDOW_EXTEND_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_WINDOW_EXTEND_SYSTEM",	0);
#endif

#ifdef ENABLE_SAFEBOX_CHECKING_FIX
	PyModule_AddIntConstant(poModule, "ENABLE_SAFEBOX_CHECKING_FIX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SAFEBOX_CHECKING_FIX", 0);
#endif

#ifdef ENALBE_SAGE_SKILL_SYSTEM
	PyModule_AddIntConstant(poModule, "ENALBE_SAGE_SKILL_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENALBE_SAGE_SKILL_SYSTEM",	0);
#endif

#ifdef ENABLE_USER_PANEL
	PyModule_AddIntConstant(poModule, "ENABLE_USER_PANEL",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_USER_PANEL",	0);
#endif

#ifdef ENABLE_DUEL_ADVANCED_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_DUEL_ADVANCED_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DUEL_ADVANCED_SYSTEM",	0);
#endif

#ifdef ENABLE_VIEW_MOB_TARGET_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_VIEW_MOB_TARGET_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_VIEW_MOB_TARGET_SYSTEM", 0);
#endif

#ifdef ENABLE_VIEW_SASH_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_VIEW_SASH_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_VIEW_SASH_SYSTEM",	0);
#endif

#ifdef EQUIP_ENABLE_VIEW_ACCE
	PyModule_AddIntConstant(poModule, "EQUIP_ENABLE_VIEW_ACCE",	1);
#else
	PyModule_AddIntConstant(poModule, "EQUIP_ENABLE_VIEW_ACCE",	0);
#endif

#ifdef ENABLE_FOREX_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_FOREX_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FOREX_SYSTEM",	0);
#endif

#ifdef ENABLE_TEMPLE_OCHAO_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_TEMPLE_OCHAO_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TEMPLE_OCHAO_SYSTEM", 0);
#endif
...
#ifdef ENABLE_GF_MOUNT_UPDATE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_GF_MOUNT_UPDATE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GF_MOUNT_UPDATE_SYSTEM", 0);
#endif

#ifdef ENABLE_SHOP_BOARD_RANGE
	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_BOARD_RANGE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_BOARD_RANGE", 0);
#endif

#ifdef ENABLE_EXCHANGE_EX
	PyModule_AddIntConstant(poModule, "ENABLE_EXCHANGE_EX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXCHANGE_EX", 0);
#endif
...
#ifdef ENABLE_SAVE_COORD_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SAVE_COORD_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SAVE_COORD_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SLOT_ICON_EX_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SLOT_ICON_EX_SYSTEM", 0);
#endif

#ifdef ENABLE_WHISPER_FLASHING_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_WHISPER_FLASHING_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WHISPER_FLASHING_SYSTEM", 0);
#endif
...
#ifdef ENABLE_BIOLOG_EX_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_BIOLOG_EX_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BIOLOG_EX_SYSTEM",	0);
#endif
...
#ifdef ENABLE_MASTER_AFFECTIVE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_MASTER_AFFECTIVE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MASTER_AFFECTIVE_SYSTEM", 0);
#endif
...
#ifdef ENABLE_MAINTENANCE_MODE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_MAINTENANCE_MODE_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MAINTENANCE_MODE_SYSTEM",	0);
#endif

#ifdef TICARET_EFEKTI
	PyModule_AddIntConstant(poModule, "TICARET_EFEKTI", 1);
#else
	PyModule_AddIntConstant(poModule, "TICARET_EFEKTI", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_GF_CHEQUE_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GF_CHEQUE_SYSTEM",	0);
#endif

#ifdef ENABLE_SEAL_BIND_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SEAL_BIND_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SEAL_BIND_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SHOPEX_SYSTEM_NEW", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOPEX_SYSTEM_NEW", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_TRADABLE_ICON_GF", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_TRADABLE_ICON_GF", 0);
#endif

#ifdef ENABLE_LOGIN_SECURITY_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_LOGIN_SECURITY_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LOGIN_SECURITY_SYSTEM", 0);
#endif

#ifdef ENABLE_PRESTIGE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_PRESTIGE_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRESTIGE_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_GF_UPDATE_MESSENGER_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GF_UPDATE_MESSENGER_SYSTEM",	0);
#endif

#ifdef ENABLE_PET_SLOT_LIKE_RUBINUM
	PyModule_AddIntConstant(poModule, "ENABLE_PET_SLOT_LIKE_RUBINUM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PET_SLOT_LIKE_RUBINUM", 0);
#endif
...
#ifdef ENABLE_MAGIC_STONE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_MAGIC_STONE_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MAGIC_STONE_SYSTEM",	0);
#endif

#ifdef ENABLE_CHAT_MODE_DICE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_MODE_DICE_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_MODE_DICE_SYSTEM",	0);
#endif

#ifdef ENABLE_SAFEBOX_WINDOW_EX_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SAFEBOX_WINDOW_EX_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SAFEBOX_WINDOW_EX_SYSTEM", 0);
#endif

#ifdef ENABLE_OFFLINESHOP_SYSTEM_SK
	PyModule_AddIntConstant(poModule, "ENABLE_OFFLINESHOP_SYSTEM_SK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_OFFLINESHOP_SYSTEM_SK", 0);
#endif

#ifdef ENABLE_PRIVATESHOPSEARCH_SYSTEM_NOVA
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATESHOPSEARCH_SYSTEM_NOVA", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATESHOPSEARCH_SYSTEM_NOVA", 0);
#endif
}
