...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_GC_NEWQUICKSLOT_ADD,		CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCNewQuickSlotAdd), STATIC_SIZE_PACKET));
			Set(HEADER_GC_NEWQUICKSLOT_DEL,		CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCNewQuickSlotDel), STATIC_SIZE_PACKET));
			Set(HEADER_GC_NEWQUICKSLOT_SWAP,	CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCNewQuickSlotSwap), STATIC_SIZE_PACKET));
#endif
			...
			Set(HEADER_GC_TICKET_LOGS, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketTicketLogsData), STATIC_SIZE_PACKET));
			Set(HEADER_GC_TICKET_LOGS_REPLY, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketTicketLogsDataReply), STATIC_SIZE_PACKET));
#endif
			...
			Set(HEADER_GC_USER_CONTROL,	CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketCGUserControl), STATIC_SIZE_PACKET));
#endif
...
//			return rkSimplePlayerInfo.wParts[CRaceData::PART_MAIN];
		...
		case ACCOUNT_CHARACTER_SLOT_ACCE:
			...
			break;
		case ACCOUNT_CHARACTER_SLOT_WARPOINT:
			return rkSimplePlayerInfo.lWarPoint;
			break;
	}
	return 0;
}
