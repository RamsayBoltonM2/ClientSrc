...
class IAbstractPlayer : public TAbstractSingleton<IAbstractPlayer>
{
	public:
		...
		virtual void	AddNewQuickSlot(int QuickslotIndex, char IconType, char IconPosition) = 0;
		virtual void	DeleteNewQuickSlot(int QuickslotIndex) = 0;
		virtual void	MoveNewQuickSlot(int Source, int Target) = 0;
#endif
