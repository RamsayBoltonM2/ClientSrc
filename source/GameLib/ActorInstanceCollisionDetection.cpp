...
BOOL CActorInstance::TestPhysicsBlendingCollision(CActorInstance & rVictim)
{
	...
	if (rVictim.GetRace() == 30000 ||
		rVictim.GetRace() == 20101 ||
		rVictim.GetRace() == 20102 ||
		rVictim.GetRace() == 20103 ||
		rVictim.GetRace() == 20104 ||
		rVictim.GetRace() == 20105 ||
		rVictim.GetRace() == 20106 ||
		rVictim.GetRace() == 20107 ||
		rVictim.GetRace() == 20108 ||
		rVictim.GetRace() == 20109 ||
		rVictim.GetRace() == 20110 ||
		rVictim.GetRace() == 20111 ||
		rVictim.GetRace() == 20112 ||
		rVictim.GetRace() == 20113 ||
		rVictim.GetRace() == 20114 ||
		rVictim.GetRace() == 20115 ||
		rVictim.GetRace() == 20116 ||
		rVictim.GetRace() == 20117 ||
		rVictim.GetRace() == 20118 ||
		rVictim.GetRace() == 34001 ||
		rVictim.GetRace() == 34002 ||
		rVictim.GetRace() == 34003 ||
		rVictim.GetRace() == 34004 ||
		rVictim.GetRace() == 34009 ||
		rVictim.GetRace() == 34010 ||
		rVictim.GetRace() == 34011 ||
		rVictim.GetRace() == 34012 ||
		rVictim.GetRace() == 34008 ||
		rVictim.GetRace() == 34007 ||
		rVictim.GetRace() == 34005 ||
		rVictim.GetRace() == 34006)
		return FALSE;

	//Moblarin icinden gecme Petler - Pazarlar -Slotlar
    if (rVictim.GetRace() >= 34001 && rVictim.GetRace() <= 34080)
        return FALSE;
...
#ifdef ENABLE_GF_SAFEZONE_UPDATE
...
* The first value is the minimum value and the second value is the maximum value of pet vnum (mob_proto) - change 34051 with your max vnum of pet */	
	int pListPet[42] = {34041, 34045, 34049, 34053, 34012, 34020, 34041, 34001, 34002, 34003, 34004, 34005, 34006, 34007, 34008, 34009, 34010, 34011, 53008, 34012, 34013, 34014, 34015, 34016, 34017, 34018, 34019, 34020, 34021, 34022, 34023, 34024, 34025, 34026, 34027, 34028, 34029, 34030, 34031, 34032, 34033, 34034};	
/************
* You can add whatever you like vnum of npc or monster (mob_proto) */
	int pListGlobal[16] = {9001, 9002, 9003, 9004, 9005, 9006, 20011, 20091, 20092, 20093, 20094, 20095, 30000, 34012, 34011, 53008};
/************
...
*/
	...
	if (rVictim.GetRace()>=34001 && rVictim.GetRace()<=34199)
		return FALSE;

	if (rVictim.GetRace()>=30000 && rVictim.GetRace()<=30004)
		return FALSE;
